        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                  ...
                  <div className="px-4 pb-6">
                    <div className="rounded-xl bg-zinc-900/60 p-3 flex items-center gap-3">
                      <div className="w-10 h-10 rounded-lg bg-accent/20 flex items-center justify-center text-accent">
                        <IconFire size={20} weight="duotone" />
                      </div>
                      <div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="glass-card px-6 py-3 flex items-center gap-3 opacity-50 cursor-not-allowed">
              ...
              <div className="glass-card px-6 py-3 flex items-center gap-3 opacity-50 cursor-not-allowed">
                <GooglePlayLogo size={24} weight="duotone" className="text-white" />
                <div>
