  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        .nav_container { display: flex; align-items: center; justify-content: space-between; height: 4.5rem; max-height: 4.5rem; padding-top: 0.5rem; padding-bottom: 0.5rem; }
        .nav_logo { height: 3.5rem; width: auto; object-fit: contain; }
